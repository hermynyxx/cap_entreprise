...
<div class="card text text-start p-3 m-3 card-review">
    <div class="row">
        <div class="col-lg-2 col-md-3 col-sm-4">
            <img src="https://img.freepik.com/photos-gratuite/portrait-belle-jeune-femme-coiffure-elegante-lunettes_1142-40217.jpg?w=740&t=st=1706786934~exp=1706787534~hmac=b6fc1dc732b60dbd5d252ae03ec0aa05cc1412f7d95b92d872ebc380ce45b545" alt="logo" id="logo" style="width:90px; height:90px">
            <h6 class="card-title"><a class="btn-link" href="${UrlRoute.URL_USER}/${review.gamer.uuid}">${review.gamer.nickname}</a></h5>
